           ...
           <div class="carousel-indicators">
            ...
            <div class="carousel-caption ">
                    ...
                    <span className="span">Science Fiction</span>
                        ...
                        <button className="wat-btn" onClick={()=>viewMovieHandler(movie[0])}> WATCH TRAILLER</button>
                    </div>
                </div>
            </div>
            ...
            <img  class="d-block w-100"/> 
                <div class="carousel-caption  ">
                    ...
                    <PlayButton item={movie[0]}/>
                    <button className="wat-btn" onClick={()=>viewMovieHandler(movie[1])}> WATCH TRAILLER</button>
                  </div>
                </div>
            </div>
            ...
            <img  class="d-block w-100"/> 
                <div class="carousel-caption ">
                    ...
                    <span className="span">Science Fiction</span>
                        ...
                        <PlayButton item={movie[0]}/>
                        <button className="wat-btn" onClick={()=>viewMovieHandler(movie[2])}> WATCH TRAILLER</button>
                    </div>
                </div>
            </div>
            ...
            <img  class="d-block w-100"/> 
                <div class="carousel-caption ">
                    ...
                    <span className="span">Science Fiction</span>
                        ...
                        <PlayButton item={movie[0]}/>
                        <button className="wat-btn" onClick={()=>viewMovieHandler(movie[3])}> WATCH TRAILLER</button>
                    </div>
                </div>
            </div>
            ...
            <img  class="d-block w-100"/> 
                <div class="carousel-caption ">
                    ...
                    <span className="span">Science Fiction</span>
                        ...
                        <PlayButton item={movie[0]}/>
                        <button className="wat-btn" onClick={()=>viewMovieHandler(movie[4])}> WATCH TRAILLER</button>
                    </div>
                </div>
            </div>
        </div>
